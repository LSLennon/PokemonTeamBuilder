const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
	...
	[MOVE_BONEMERANG] =
	{
			.flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_DMG_UNGROUNDED_IGNORE_TYPE_IF_FLYING | FLAG_TWO_STRIKES,T_DOUBLE_HIT,
		.power = 50,
		.type = TYPE_GROUND,
		.accuracy = 90,
		.pp = 10,
