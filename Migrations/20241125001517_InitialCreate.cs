    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MoveLearnMethodId = table.Column<int>(type: "INTEGER", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokeMethods", x => x.MoveLearnMethodId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_stats", x => x.PokeStatsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PokedexPokemonId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovesLearnedByPokemons", x => new { x.PokeMoveId, x.PokedexPokemonId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovesLearnedByPokemons_PokeMoves_PokeMoveId",
                        column: x => x.PokeMoveId,
                        principalTable: "PokeMoves",
                        principalColumn: "PokeMoveId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovesLearnedByPokemons_PokedexPokemons_PokedexPokemonId",
                        column: x => x.PokedexPokemonId,
                        principalTable: "PokedexPokemons",
                        principalColumn: "PokedexPokemonId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovesLearnedByPokemons_PokedexPokemonId",
                table: "MovesLearnedByPokemons",
                column: "PokedexPokemonId");
