...
namespace PokemonTeamBuilder.Migrations
{
    ...
    [Migration("20241203124621_UpdateDatabaseTwo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokemonTeamBuilder.Components.Classes.ManyToMany.PokemonCustom.MCustomToTeams", b =>
                {
                    b.Property<int>("MCustomToTeamsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("MCustomToTeamsId");

                    b.HasIndex("CustomPokemonId");

                    b.HasIndex("UserTeamId");

                    b.ToTable("MCustomToTeams");
                });
            ...
            modelBuilder.Entity("PokemonTeamBuilder.Components.Classes.Trainers.Trainer", b =>
                {
            ...
            modelBuilder.Entity("PokemonTeamBuilder.Components.Classes.UsersData.UserBox", b =>
                {
                    b.Property<int>("UserBoxId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("UserBoxName")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PokemonTeamBuilder.Components.Classes.UsersData.CustomPokemon", b =>
                {
                    ...
                    b.HasOne("PokemonTeamBuilder.Components.Classes.Trainers.Trainer", null)
                        .WithMany("CustomPokemons")
                        .HasForeignKey("TrainerId");

                    b.HasOne("PokemonTeamBuilder.Components.Classes.UsersData.UserBox", "UserBox")
                        .WithMany("CustomPokemons")
                        .HasForeignKey("UserBoxId");

                    b.HasOne("PokemonTeamBuilder.Components.Classes.UsersData.UserTeam", null)
                        .WithMany("CustomPokemons")
                        .HasForeignKey("UserTeamId");
            ...
            modelBuilder.Entity("PokemonTeamBuilder.Components.Classes.UsersData.CustomPokemon", b =>
                {
                    ...
                    b.Navigation("CustomToTeams");
                });

            modelBuilder.Entity("PokemonTeamBuilder.Components.Classes.UsersData.User", b =>
                {
                    b.Navigation("UserBoxs");
